...
// parse command line
$opts = getopt('', Array('board:', 'themes', 'js', 'indexes', 'threads', 'processes:', 'cache', 'cache_noboard', 'postmarkup', 'api'));
$options = Array();
...
// Exit after clearing the cache?
$options['cache_noboard'] = isset($opts['cache_noboard']);
...
if ($options['cache'] || $options['cache_noboard']) {
	echo "Clearing template cache...\n";
	load_twig();
	$twig->clearCacheFiles();
	if($options['cache_noboard']) {
